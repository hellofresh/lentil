...
module.exports = {
    emergency: (err) => {
        if (global.LOG_LEVEL > LEVELS.ERROR) {
            return;
        }
    ...
    warning: (err) => {
        if (global.LOG_LEVEL > LEVELS.WARN) {
            return;
        }
    ...
    notice: (message, context) => {
        if (global.LOG_LEVEL > LEVELS.INFO) {
            return;
        }
    ...
    debug: (message, context) => {
        if (global.LOG_LEVEL > LEVELS.DEBUG) {
            return;
        }
    ...
    log: (message, context) => {
        if (global.LOG_LEVEL > LEVELS.TRACE) {
            return;
        }
